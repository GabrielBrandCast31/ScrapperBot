        ...
        <Card>
          <CardContent className="p-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold">{data?.me?.id ? data.me.id.replace("@c.us", "") : "—"}</p>
              {data?.me?.pushName && <p className="text-xs text-muted-foreground">{data.me.pushName}</p>}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            {status && <Badge variant="outline" className={cor}>{status}</Badge>}
          </div>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1 space-y-4 text-sm">
              ...
              <p className="text-xs text-muted-foreground">Atualizado em tempo real (polling a cada 3s).</p>
            </div>
          </div>
        </CardContent>
      </Card>
