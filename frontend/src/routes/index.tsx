  ...
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      >
        <CardContent className="p-4 flex items-center gap-4 flex-wrap">
          ...
          <Button asChild size="sm" variant="outline" className="gap-1">
            <Link to="/conexao">
              Gerenciar conexão <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          </Button>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-5 xl:grid-cols-2">
          ...
          <CardContent className="p-0">
            ...
            <div className="divide-y divide-border/60">
              {top.slice(0, 6).map((c) => (
                <div
                  key={c.chat_id}
                  className="grid grid-cols-[1fr_80px_80px_60px] gap-3 items-center px-5 py-3"
                >
        ...
        {/* Últimos resumos da Auditoria IA */}
        <Card>
          <CardHeader className="flex flex-row items-start justify-between">
            <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Link
          to="/chat-ia"
          className="rounded-lg border border-primary/30 bg-primary/5 p-4 hover:bg-primary/10 transition-colors"
        >
