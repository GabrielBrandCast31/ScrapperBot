...
function ConversaDetail() {
  ...
  // Mensagens vem DESC do backend; render ascendente (mais antiga em cima)
  ...
  return (
    <div className="grid h-[calc(100vh-3.5rem)] grid-rows-[auto_1fr] xl:grid-cols-[1fr_380px] xl:grid-rows-1">
      ...
      <div className="flex h-full min-h-0 flex-col border-r border-border/60">
        ...
        <div className="flex items-center gap-3 border-b border-border/60 px-5 py-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground">
              {c ? `${c.total} mensagens carregadas` : ""}
            </p>
          </div>
                    ...
                    >
                      ...
                      {m.quando && (
                        <p
                          className={
                            "mt-1 text-[10px] " +
                            (isTeam ? "opacity-80" : "text-muted-foreground")
                          }
                        >
                          {m.quando}
                        </p>
        ...
        {/* Composer placeholder (envio nao suportado — observe-only) */}
        ...
        {ultimoResumo ? (
          ...
          <Card>
            <CardContent className="p-4 text-sm text-muted-foreground">
              Nenhum resumo da Auditoria IA gerado pra essa conversa ainda. A
              auditoria roda automaticamente a cada 1h (3h à noite).
            </CardContent>
          </Card>
        )}
